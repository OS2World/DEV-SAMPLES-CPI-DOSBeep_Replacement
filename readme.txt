...
First validate if the EXE uses DosBeep. If have an exe called MyApp.Exe, then do this:
...
and build it with the instructions on "build.txt".
...
==REFERENCE==
This sample is based in the NEWCALLS sample of “Hook code to circumvent built-in methods of OS/2” by Peter Fitzsimmons. 
